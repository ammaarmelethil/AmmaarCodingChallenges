...
public class ItineraryTest {
	private Date getDate(int year, int month, int day, int hour, int minute) {
		...
		public void test_addFlight_addingOne() {
			...
			assertEquals("Itinerary only has one flight - testing departure.", getDate(2019,1,1,10,30), m2.getStart());
			assertEquals("Itinerary only has one flight - testing arrival.", getDate(2019,1,1,18,1), m2.getEnd());
		}
		...
		public void test_addflight_addingManyInOrder() {
			...
			assertEquals("flight 1 test - testing departure", getDate(2019,1,1,10,0), list.get(0).getStart());
			assertEquals("flight 2 test - testing departure", getDate(2019,1,1,11,30), list.get(1).getStart());
			assertEquals("flight 3 test - testing departure", getDate(2019,1,1,14,50), list.get(2).getStart());
			assertEquals("flight 4 test - testing departure", getDate(2019,1,1,23,30), list.get(3).getStart());
			assertEquals("flight 5 test - testing departure", getDate(2019,1,2,4,40), list.get(4).getStart());
			assertEquals("flight 6 test - testing departure", getDate(2019,1,2,9,40), list.get(5).getStart());
		}
		...
		public void test_addflight_addingRandomOrder() {
			...
			assertEquals("Expected list of size 6 after adding 6 flights", 6, list.size());			
			assertEquals("Insertion order: 4,6,1,5,2,3, flight 1 test - testing departure", getDate(2019,1,1,10,0), list.get(0).getStart());
			assertEquals("Insertion order: 4,6,1,5,2,3, flight 2 test - testing departure", getDate(2019,1,1,11,30), list.get(1).getStart());
			assertEquals("Insertion order: 4,6,1,5,2,3, flight 3 test - testing departure", getDate(2019,1,1,14,50), list.get(2).getStart());
			assertEquals("Insertion order: 4,6,1,5,2,3, flight 4 test - testing departure", getDate(2019,1,1,23,30), list.get(3).getStart());
			assertEquals("Insertion order: 4,6,1,5,2,3, flight 5 test - testing departure", getDate(2019,1,2,4,40), list.get(4).getStart());
			assertEquals("Insertion order: 4,6,1,5,2,3, flight 6 test - testing departure", getDate(2019,1,2,9,40), list.get(5).getStart());
		}
